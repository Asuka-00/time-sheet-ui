export default {
  ...
  placeholder: {
    ...
    director: 'Please select project director',
  ...
  validation: {
    ...
    directorRequired: 'Project director is required',
  ...
  message: {
    ...
    deleteWarning:
      'Deleting this project will also remove all member records. This action cannot be undone.',
